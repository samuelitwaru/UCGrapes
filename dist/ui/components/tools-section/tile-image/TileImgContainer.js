export class TileImgContainer {
    ...
    init() {
        ...
        button.addEventListener("click", (e) => {
            ...
            globalThis.tileMapper.updateTile(selectedComponent.parent().getId(), "BGImageUrl", "");
            globalThis.tileMapper.updateTile(selectedComponent.parent().getId(), "Opacity", "0");
...
//# sourceMappingURL=TileImgContainer.js.map