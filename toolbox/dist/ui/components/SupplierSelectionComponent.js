...
export class SupplierSelectionComponent {
    ...
    filterOptions(searchTerm, optionsContainer) {
        ...
        options.forEach(option => {
            ...
            const text = ((_a = optionEl.textContent) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || '';
    ...
    removeSelection() {
        const popup = document.querySelector(".popup-modal-link");
        const valueField = popup === null || popup === void 0 ? void 0 : popup.querySelector("#field_value");
        if (valueField) {
            valueField.value = "";
...
//# sourceMappingURL=SupplierSelectionComponent.js.map