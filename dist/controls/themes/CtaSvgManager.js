...
export class CtaSvgManager {
    ...
    phoneCta(ctaButton, id) {
        ...
        <div ${ctaTileDEfaultAttributes} data-gjs-type="cta-buttons" button-type="${ctaButton.CallToActionType}" class="cta-container-child cta-child" id="${id}">
                    ...
                    <div ${DefaultAttributes} id="irtak" data-gjs-type="text" class="cta-label label">${ctaButton.CallToActionName}</div>
        </div>
        `;
    }
    emailCta(ctaButton, id) {
        return `
        <div ${ctaTileDEfaultAttributes} data-gjs-type="cta-buttons"  button-type="${ctaButton.CallToActionType}" class="cta-container-child cta-child" id="${id}">
...
//# sourceMappingURL=CtaSvgManager.js.map