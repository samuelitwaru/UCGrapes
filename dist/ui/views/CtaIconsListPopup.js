...
export class CtaIconsListPopup {
    ...
    `;
            ...
            ctaIcons === null || ctaIcons === void 0 ? void 0 : ctaIcons.forEach((item) => {
        ...
        if (selectedComponent && pageData) {
            if (pageData.PageType === "Information") {
                ...
                if (tileInfoSectionAttributes) {
                    ...
                    ctaAttributes = tileInfoSectionAttributes === null || tileInfoSectionAttributes === void 0 ? void 0 : tileInfoSectionAttributes.CtaAttributes;
                }
            }
            else {
                const pageId = globalThis.pageId;
                const contentMapper = new ContentMapper(pageData === null || pageData === void 0 ? void 0 : pageData.PageId);
...
//# sourceMappingURL=CtaIconsListPopup.js.map