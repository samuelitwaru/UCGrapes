        ...
        ${(this.data?.PageType === "Location" || this.data?.PageType === "Reception") ? `style="right: -20px"` : ``}>
          ...
          <div ${DefaultAttributes} class="slideshow-container" id="${randomIdGenerator(15)}">
                ...
                ${values
                  ...
                  <div ${DefaultAttributes} class="numbertext ">${index + 1} / ${values.length}</div>
                  <img  ${DefaultAttributes}
                          class="product-service-image"                
                          src="${value.InfoImageValue}"
                          data-gjs-type="default"
                          alt="Full-width Image"
                  />
                 </div>
          ...
          <script>
            ...
            function showSlides() {
              ...
              console.log('here');
              console.log((globalThis as any).activeEditor.DomComponents.getWrapper());
