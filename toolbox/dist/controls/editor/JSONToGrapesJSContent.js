import { contentColumnDefaultAttributes, contentDefaultAttributes, ctaTileDEfaultAttributes, DefaultAttributes, ctaContainerDefaultAttributes, } from "../../utils/default-attributes";
...
export class JSONToGrapesJSContent {
    ...
    generateHTML() {
        ...
        let contentHtml = "";
        let ctaHtml = "";
        if (((_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.PageContentStructure) === null || _b === void 0 ? void 0 : _b.Content) &&
            Array.isArray(this.data.PageContentStructure.Content)) {
            contentHtml = this.data.PageContentStructure.Content.map((content) => this.generateContent(content)).join("");
        }
        if (((_d = (_c = this.data) === null || _c === void 0 ? void 0 : _c.PageContentStructure) === null || _d === void 0 ? void 0 : _d.Cta) &&
            Array.isArray(this.data.PageContentStructure.Cta)) {
            ctaHtml = this.data.PageContentStructure.Cta.map((cta) => this.generateCta(cta)).join("");
        }
        const htmlData = `
    ...
    contentImage(content) {
        var _a, _b, _c, _d;
        return `
    <div ${contentDefaultAttributes} class="content-image" id="${(content === null || content === void 0 ? void 0 : content.ContentId) ? content === null || content === void 0 ? void 0 : content.ContentId : randomIdGenerator(15)}" data-gjs-type="product-service-image">
        ...
        <img
            ...
            ${DefaultAttributes}
            src="${content === null || content === void 0 ? void 0 : content.ContentValue}"
    ...
    <div
        ...
        id="${(content === null || content === void 0 ? void 0 : content.ContentId) ? content === null || content === void 0 ? void 0 : content.ContentId : randomIdGenerator(15)}"
    ...
    >
      ...
      ${this.addGrapesAttributes(`<div ${DefaultAttributes} id="contentDescription">${content === null || content === void 0 ? void 0 : content.ContentValue}</div>`)}      
    </div>
    `;
    }
}
//# sourceMappingURL=JSONToGrapesJSContent.js.map