...
export class NewPageButton {
    constructor(toolboxService, appVersionManager, parentPage) {
        ...
        childContainer === null || childContainer === void 0 ? void 0 : childContainer.appendChild(menuContainer);
    }
    render() {
        ...
        if (this.parentPage.PageName == "Home") {
            ...
            menuButton.addEventListener("mouseover", () => {
                ...
                const children = ((_a = menuContainer === null || menuContainer === void 0 ? void 0 : menuContainer.parentNode) === null || _a === void 0 ? void 0 : _a.children) || [];
    ...
    createNewPage(title) {
        return __awaiter(this, void 0, void 0, function* () {
            const appVersion = globalThis.activeVersion;
