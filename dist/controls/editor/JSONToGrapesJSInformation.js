...
import { contentDefaultAttributes, ctaTileDEfaultAttributes, DefaultAttributes, DefaultInfoColumnAttributes, } from "../../utils/default-attributes";
...
export class JSONToGrapesJSInformation {
    ...
    generateCta(infoContent) {
        const cta = infoContent.CtaAttributes;
        if ((cta === null || cta === void 0 ? void 0 : cta.CtaButtonType) === "Image") {
        ...
        else if ((cta === null || cta === void 0 ? void 0 : cta.CtaButtonType) === "FullWidth") {
            return `
            <div
        ...
        else if ((cta === null || cta === void 0 ? void 0 : cta.CtaButtonType) === "Icon") {
            return `
      ...
      `;
        ...
        else if ((cta === null || cta === void 0 ? void 0 : cta.CtaButtonType) === "Round") {
            return `
    ...
    ctaIcon(cta) {
        ...
        if (cta.CtaButtonIcon) {
            const svg = (_a = ctaIcons.find(icon => icon.name === cta.CtaButtonIcon)) === null || _a === void 0 ? void 0 : _a.svg;
            ...
            if (newSvgElement) {
                ...
                pathElements.forEach(path => {
                    path.setAttribute('fill', (cta === null || cta === void 0 ? void 0 : cta.CtaColor) || '#fff');
                });
    ...
    generateHTML() {
        ...
        let contentHtml = "";
        let ctaHtml = "";
        if (((_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.PageInfoStructure) === null || _b === void 0 ? void 0 : _b.InfoContent) &&
            Array.isArray(this.data.PageInfoStructure.InfoContent)) {
            contentHtml = this.data.PageInfoStructure.InfoContent.map((content) => this.generateInfoContent(content)).join("");
        }
        const htmlData = `
    ...
    contentInfoImage(content) {
        var _a, _b, _c, _d;
        return `
    <div ${contentDefaultAttributes} class="info-image-section" id="${(content === null || content === void 0 ? void 0 : content.InfoId) ? content === null || content === void 0 ? void 0 : content.InfoId : randomIdGenerator(15)}" data-gjs-type="info-image-section">
        <button ${DefaultAttributes} class="tb-edit-image-icon"
        ${(((_a = this.data) === null || _a === void 0 ? void 0 : _a.PageType) === "Location" || ((_b = this.data) === null || _b === void 0 ? void 0 : _b.PageType) === "Reception") ? `style="right: -20px"` : ``}>
          ...
          ${(((_c = this.data) === null || _c === void 0 ? void 0 : _c.PageType) === "Location" || ((_d = this.data) === null || _d === void 0 ? void 0 : _d.PageType) === "Reception") ? `` : `
    ...
    contentInfoDescription(content) {
        return `<div
              style="flex: 1; padding: 0; margin: 0; height: auto; white-space: normal;"
              class="info-desc-section"
              ${contentDefaultAttributes} 
              id="${(content === null || content === void 0 ? void 0 : content.InfoId) ? content === null || content === void 0 ? void 0 : content.InfoId : randomIdGenerator(15)}"
          ...
          >
            ...
            ${this.addGrapesAttributes(`<div ${DefaultAttributes} class="info-desc-content">${content === null || content === void 0 ? void 0 : content.InfoValue}</div>`)}      
          </div>
    `;
    }
    getDefaultContent() {
...
//# sourceMappingURL=JSONToGrapesJSInformation.js.map