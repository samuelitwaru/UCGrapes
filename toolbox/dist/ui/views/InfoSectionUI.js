import { contentDefaultAttributes, ctaTileDEfaultAttributes, DefaultAttributes, infoRowDefaultAttributes, tileDefaultAttributes, tileWrapperDefaultAttributes, } from "../../utils/default-attributes";
...
export class InfoSectionUI {
    ...
    <div id="${cta.CtaId}" 
        ...
        <div ${DefaultAttributes} class="img-button cta-styled-btn"
            ...
            <span ${DefaultAttributes} class="img-button-label label" style="color:${cta.CtaColor ? cta.CtaColor : "#ffffff"}">${cta.CtaLabel}</span>
                        <i ${DefaultAttributes} class="fa fa-angle-right img-button-arrow" style="color:${cta.CtaColor ? cta.CtaColor : "#ffffff"}"></i>
        </div>
    </div>`;
        return imgButton;
    }
    ...
    getDescription(description) {
      ...
      <div
          ...
          >
            ...
            ${this.addGrapesAttributes(`<div ${DefaultAttributes} class="info-desc-content">${description}</div>`)}      
          </div>
      `;
    }
    getImage(imageUrl) {
...
//# sourceMappingURL=InfoSectionUI.js.map