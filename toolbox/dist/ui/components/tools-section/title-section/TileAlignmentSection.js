...
export class TileAlignmentSection {
    ...
    init() {
        ...
        leftAlign.onclick = (e) => {
            e.preventDefault();
            const leftAlignInput = document.getElementById("tile-left");
            ...
            if (pageData.PageType === "Information") {
                ...
                infoSectionController.updateInfoTileAttributes(selectedComponent.parent().parent().getId(), selectedComponent.parent().getId(), "Align", "left");
            }
            else {
                globalThis.tileMapper.updateTile(selectedComponent.parent().getId(), "Align", "left");
            }
            leftAlignInput.checked = true;
        };
        centerAlign.onclick = (e) => {
            e.preventDefault();
            const centerAlignInput = document.getElementById("tile-center");
            const selectedComponent = globalThis.selectedComponent;
            if (!selectedComponent)
                return;
            selectedComponent.addStyle({
            ...
            if (pageData.PageType === "Information") {
                const infoSectionController = new InfoSectionController();
                infoSectionController.updateInfoTileAttributes(selectedComponent.parent().parent().getId(), selectedComponent.parent().getId(), "Align", "center");
            }
            else {
                globalThis.tileMapper.updateTile(selectedComponent.parent().getId(), "Align", "center");
            }
...
//# sourceMappingURL=TileAlignmentSection.js.map