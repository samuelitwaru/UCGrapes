...
export class PageAppBar {
    constructor(id, title) {
        ...
        this.editorWidth = globalThis.deviceWidth;
        this.init();
    }
    init() {
        ...
        backButton === null || backButton === void 0 ? void 0 : backButton.addEventListener('click', (e) => {
            ...
            if (currentFrame) {
                ...
                if (thumbToRemove) {
                    (_f = (_e = (_d = thumbToRemove.parentElement) === null || _d === void 0 ? void 0 : _d.parentElement) === null || _e === void 0 ? void 0 : _e.parentElement) === null || _f === void 0 ? void 0 : _f.remove();
                }
                currentFrame.remove();
    ...
    resetTitle(pageTitle, editHeader, saveChange, titleDiv) {
...
//# sourceMappingURL=PageAppBar.js.map