...
const outputFilePath: string = path.join(__dirname, 'bundle.js');

function combineFiles(files: string[], outputFilePath: string): void {
...
function minifyFile(filePath: string): void {
    ...
    fs.writeFileSync(filePath, minifiedContent.code as string, 'utf-8');
